...
def busca_cep(event=None):
    ...
    try:
        ...
        endereco_box = tk.Label(endereco_frame, text="Endereço: "+logradouro+" "+complemento, font=("Arial", 12))
        endereco_box.pack()
        
        bairro_frame = tk.Frame(root, bd=1, relief="solid")
        bairro_frame.place(x=30, y=140)
        
        bairro_box = tk.Label(bairro_frame, text="Bairro: "+bairro, font=("Arial", 12))
        bairro_box.pack()
        
        cidade_frame = tk.Frame(root, bd=1, relief="solid")
        cidade_frame.place(x=30, y=170)
        
        cidade_box = tk.Label(cidade_frame, text="Cidade: "+localidade+"-"+uf, font=("Arial", 12))
        cidade_box.pack()
...
buscar_button = tk.Button(root, text="Buscar", font=("Arial", 12), command=busca_cep)
